...
curl -I https://github.com/Moon-python/zotero-reading-flow/releases/download/v1.1.8/zotero-reading-flow.xpi
```
...
For `v1.1.8`, the release should be described as tested with Zotero `9.0.1` and compatible with Zotero `9.0.*`.
