...
curl -I https://github.com/Moon-python/zotero-reading-flow/releases/download/v1.1.0/zotero-reading-flow.xpi
```
...
For `v1.1.0`, the release should be described as tested with Zotero `9.0.1` and compatible with Zotero `9.0.*`.
