...
|---|---|---|
| `columns.png` | Primary README image. Library item tree with `Flow` visible and optional `Progress`, `State`, and `Last Read` detail columns on several papers in mixed states (`To Read`, `Reading`, `Read Next`, `Later`, `Done`). | 1200-1600 px wide, PNG |
