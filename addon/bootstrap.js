      ...
      if (!this.treeInstance)
        new Promise((resolve) => {
          ...
          if (vtableProps.getRowData && !vtableProps.renderItem)
            Object.assign(vtableProps, { renderItem: this.VirtualizedTable.makeRowRenderer(vtableProps.getRowData) });
...
var install = ReadingFlowBootstrap.install; var startup = ReadingFlowBootstrap.startup; var shutdown = ReadingFlowBootstrap.shutdown; var uninstall = ReadingFlowBootstrap.uninstall;
